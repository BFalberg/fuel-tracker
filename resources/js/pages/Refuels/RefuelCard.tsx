...
import { BanknoteIcon, Calendar, Car, Droplets, Fuel, Gauge, MapPin, MoreVertical, Pencil, Trash2 } from 'lucide-react';
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => onEdit?.(refuel)}>
            ...
            <CardContent>
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">{refuel.car?.name ?? 'Unknown Station'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                        <MapPin className="text-muted-foreground h-4 w-4" />
                        <span className="text-sm">{refuel.gas_station?.name ?? 'Unknown Station'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
